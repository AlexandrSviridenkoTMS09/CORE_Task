...
public class Printer {
    ...
    public static void printClassLoaderName(ClassLoader classLoaderName) {
    ...
    static void PrintClassLoaderName(ClassLoader classLoaderName) {
        if (classLoaderName == null) {
            System.out.println("Classloader: Bootstrap");
        } else {
